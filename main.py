    ...
    try:
        while True:
            ...
            for id in azimuth_ids:
                ...
                if id == 2:
                    print(f"ID: {id}, Current Angle: {math.degrees(current_angle):.2f}° rotation delta target: {target_position_delta}, --into deg--> {math.degrees(calculate_swerve_angle(target_position_delta))}°", end = " ")
